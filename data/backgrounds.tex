...
由于核反冲信号的猝灭效应，相同能量的核反冲和电子反冲产生的光子数不同，取猝灭因子（quenching factor）为0.2，
...
图\ref{fig:all_event_rate}是两种本底和信号的汇总，因核反冲信号的猝灭效应，取猝灭因子为0.2，
将核反冲能量$T_\mathrm{nr}$乘猝灭因子转化后与电子反冲能量进行比较。

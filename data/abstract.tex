...
\begin{abstract*}
  ...
  in energy region of signal, electronic recoil background rate will be suppressed to 0.1$\left(\si{kg}\cdot\si{day}\cdot\si{keV}\right)^{-1}$,
  muon-induced nuclear recoil will be suppressed to 0.5$\left(\si{kg}\cdot\si{day}\right)^{-1}$. 
